...
/***/ function(module, exports, __webpack_require__) {
	...
	var _closestNotVisible = __webpack_require__(44);
	...
	describe('dom', function () {
	    ...
	    describe('closest', function () {
	        var container = document.querySelector('#closest');
	        it('should find the .target element', function () {
	            var checker = container.querySelector('.checker-1');
	            var closest = (0, _closest2.default)(checker, '.target');
	            (0, _chai.expect)(closest).not.to.equal(false);
	        });
	        it('should find the s-closest-target element', function () {
	            var checker = container.querySelector('.checker-1');
	            var closest = (0, _closest2.default)(checker, '[target]');
	            (0, _chai.expect)(closest).not.to.equal(false);
	        });
	        it('should not find the .closest-1 element from the closest-check-2', function () {
	            var checker = container.querySelector('.checker-2');
	            var closest = (0, _closest2.default)(checker, '.target');
	            (0, _chai.expect)(closest).to.equal(false);
	        });
	    });
	     ...
	     * closestNotVisible
	     */
	    describe('closestNotVisible', function () {
	        var container = document.querySelector('#closestNotVisible');
	        it('should find the element that has a display:none on it', function () {
	            var checker = container.querySelector('.checker-display');
	            (0, _chai.expect)((0, _closestNotVisible2.default)(checker, '.target')).not.to.equal(false);
	        });
	        it('should find the element that has an opacity:0 on it', function () {
	            var checker = container.querySelector('.checker-opacity');
	            (0, _chai.expect)((0, _closestNotVisible2.default)(checker, '.target')).not.to.equal(false);
	        });
	        it('should find the element that has a visibility:hidden on it', function () {
	            var checker = container.querySelector('.checker-visibility');
	            (0, _chai.expect)((0, _closestNotVisible2.default)(checker, '.target')).not.to.equal(false);
	        });
	        it('should not find any closest not visible element', function () {
	            var checker = container.querySelector('.checker-none');
	            (0, _chai.expect)((0, _closestNotVisible2.default)(checker, '.target')).to.equal(false);
	        });
	    });
	    ...
	    describe('dataset', function () {
	        var elm = document.querySelector('#dataset');
	        it('should have a data-hello="world"', function () {
	            (0, _chai.expect)((0, _dataset2.default)(elm, 'hello')).to.equal('world');
	        });
	        it('should set the data-hello to "coco"', function () {
	            (0, _dataset2.default)(elm, 'hello', 'coco');
	            (0, _chai.expect)((0, _dataset2.default)(elm, 'hello')).to.equal('coco');
	        });
	        it('should return the element itself on setting dataset value', function () {
	            (0, _chai.expect)((0, _dataset2.default)(elm, 'hello', 'coco')).to.equal(elm);
	        });
	        it('should apply a new camelize dataset value correctly', function () {
	            (0, _dataset2.default)(elm, 'yopYop', 'hey');
	            (0, _chai.expect)(elm.getAttribute('data-yop-yop')).to.equal('hey');
	        });
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _matches = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isVisible = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uncamelize = __webpack_require__(47);
