...
var SGoogleMapComponent = function (_SWebComponent) {
	_inherits(SGoogleMapComponent, _SWebComponent);
  ...
  */
	...
	SGoogleMapComponent.prototype.componentWillReceiveProp = function componentWillReceiveProp(name, newVal, oldVal) {};

	_createClass(SGoogleMapComponent, null, [{
		key: 'defaultProps',
