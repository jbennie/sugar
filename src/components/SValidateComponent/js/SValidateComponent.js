...
import __isColor from '../../../js/is/color'
import __isEmail from '../../../js/is/email'
import __isUrl from '../../../js/is/url'
import __isNumber from '../../../js/is/number'
import __isInteger from '../../../js/is/integer'
