...
var _distanceBetween = require('./distanceBetween');

var _distanceBetween2 = _interopRequireDefault(_distanceBetween);
...
function circleConstrain(center, radius, point) {
    var dist = (0, _distanceBetween2.default)(center, point);
    if (dist <= radius) {
        return point;
    } else {
